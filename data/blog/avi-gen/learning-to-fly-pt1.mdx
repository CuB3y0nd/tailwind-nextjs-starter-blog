...
<center>
  <Image alt="nn-8" src="https://pic.imgdb.cn/item/660ece2968eb9357130a0ee2.png" width={66} height={58} />
</center>

<Note>
  另一个比较流行的激活函数是 tanh，它的图形看起来略有不同（形如 s）并且具有<a href="https://machinelearningmastery.com/rectified-linear-activation-function-for-deep-learning-neural-networks" target="blank" style={{ color: `#8e91f2` }}>不同的属性</a>。<br />
